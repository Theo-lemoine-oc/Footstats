...
import { useTopScorersChampionsLeague } from '../../hooks/top-scorers/useTopScorers.jsx';
...
function TopScorersChampionsLeague() {
  const { topScorers, isLoading, hasError } = useTopScorersChampionsLeague();

  if(isLoading) {
    return (
        <div className='my-8 max-w-[80%] mx-auto'>
            <MainTitle content="Classement des 20 meilleurs buteurs de la Ligue des Champions 2022" />
...
export default TopScorersChampionsLeague;