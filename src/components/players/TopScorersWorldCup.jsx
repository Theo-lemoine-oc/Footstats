...
import { useTopScorersWorldCup } from '../../hooks/top-scorers/useTopScorers.jsx';
...
function TopScorersWorldCup() {
  const { topScorers, isLoading, hasError } = useTopScorersWorldCup();

  if(isLoading) {
    return (
        <div className='my-8 max-w-[80%] mx-auto'>
            <MainTitle content="Classement des 20 meilleurs buteurs de la Coupe du Monde 2022" />
...
export default TopScorersWorldCup;